...
response_playlist = requests.get('https://api.spotify.com/v1/playlists/37i9dQZEVXbMDoHDwVN2tF', params=params_playlist, headers=headers)
...
params_artist = {
    ...
    #'ids': '1TtXnWcUs0FCkaZDPGYHdf,4tZwfgrHOc3mvqYlEYSvVi'
}
...
df = pd.DataFrame(new)
nuevos_nombres_columnas = {'external_urls': 'links', 'id': 'artist_id', 'name' : 'artist_name'}
